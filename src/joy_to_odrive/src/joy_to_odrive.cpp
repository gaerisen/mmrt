// AI-generated, supervised/modified by Garrison Taylor
...
public:
        JoyToOdriveNode()
                : Node("joy_to_odrive")
        {
                scale_ = declare_parameter<double>("scale", 20.0);

                joy_sub_ = create_subscription<sensor_msgs::msg::Joy>(
                                "/joy0/joy", 10,
                                std::bind(&JoyToOdriveNode::joyCallback, this,
                                std::placeholders::_1));

                ctrl_pub_ = create_publisher<odrive_can::msg::ControlMessage>(
...
private:
        ...
        rclcpp::Publisher<odrive_can::msg::ControlMessage>::SharedPtr ctrl_pub_;
        double scale_;
};
